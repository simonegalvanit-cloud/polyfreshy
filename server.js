...
const CONFIG = {
  ...
  minBetAmount: 100, // Minimum bet in USD to count in cluster
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .bg-gradient {
      ...
      bottom: 0;
      background: 
        radial-gradient(ellipse at 20% 20%, rgba(0, 255, 102, 0.08) 0%, transparent 50%),
        radial-gradient(ellipse at 80% 80%, rgba(255, 51, 102, 0.08) 0%, transparent 50%),
        radial-gradient(ellipse at 50% 50%, rgba(0, 153, 255, 0.05) 0%, transparent 60%);
      pointer-events: none;
      z-index: 0;
    ...
    @keyframes logoGlow {
      0% { filter: drop-shadow(0 0 5px rgba(0, 255, 102, 0.3)); }
      100% { filter: drop-shadow(0 0 20px rgba(0, 255, 102, 0.6)); }
    }
